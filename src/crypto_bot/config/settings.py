...
class Settings(BaseSettings):
    ...
    postgres_password: str = Field(
        default="crypto_bot_password", alias="POSTGRES_PASSWORD"
    )
    ...
    log_file_path: str = Field(
        default="./data/logs/crypto-bot.log", alias="LOG_FILE_PATH"
    )
    ...
    enable_discord_notifications: bool = Field(
        default=False, alias="ENABLE_DISCORD_NOTIFICATIONS"
    )
    enable_email_notifications: bool = Field(
        default=False, alias="ENABLE_EMAIL_NOTIFICATIONS"
    )
